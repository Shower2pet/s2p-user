    ...
    <AppShell>
      <div className="container max-w-2xl mx-auto px-4 sm:px-6 py-4 sm:py-6 space-y-3 sm:space-y-4">
        <div className="text-center space-y-1.5 sm:space-y-2">
          <h1 className="text-xl sm:text-2xl font-bold text-foreground">{t('historyTitle')}</h1>
          <p className="text-sm sm:text-base text-muted-foreground font-light">{t('historyDesc')}</p>
        </div>
